...
public class RadiocraftCapabilities {
	...
	public static EntityCapability<IPlayerCallsignCapability, Void> CALLSIGNS = EntityCapability.createVoid(ResourceLocation.fromNamespaceAndPath(Radiocraft.MOD_ID, "callsigns"), IPlayerCallsignCapability.class);
	...
	public static void registerCapabilities(RegisterCapabilitiesEvent event) {
		...
		event.registerEntity(CALLSIGNS, EntityType.PLAYER, (player, context) -> PlayerCallsignSavedData.get(player.getServer().overworld()));
	}
}
