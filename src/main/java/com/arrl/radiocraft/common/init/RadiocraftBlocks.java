...
public class RadiocraftBlocks {
	...
	public static final RegistryObject<Block> J_POLE_ANTENNA = BLOCKS.register("j_pole_antenna", () -> new AntennaCenterBlock(PROPERTIES_STONE_NO_OCCLUDE));
	public static final RegistryObject<Block> SLIM_JIM_ANTENNA = BLOCKS.register("slim_jim_antenna", () -> new AntennaCenterBlock(PROPERTIES_STONE_NO_OCCLUDE));
