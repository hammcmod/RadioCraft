...
public record HandheldRadioState(boolean power, boolean ptt, float freq, float gain, float micGain, float receiveIndicatorStrength) {
    ...
    public static final StreamCodec<ByteBuf, HandheldRadioState> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.FLOAT, HandheldRadioState::freq,
    ...
    public static HandheldRadioState getDefault() {
        return new HandheldRadioState(false, false, 146_520_000.0f, 1.0f, 1.0f, 0.0f);
    }
}
