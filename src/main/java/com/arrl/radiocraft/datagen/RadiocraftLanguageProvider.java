...
public class RadiocraftLanguageProvider extends LanguageProvider {
	...
	static {
		...
		TRANSLATION_PROVIDERS.put("en_us", (provider) -> {
			...
			provider.add(Radiocraft.translationKey("screen", "chargecontroller.no_output"), "No output");
			provider.add(Radiocraft.translationKey("screen", "chargecontroller.charging"), "Charging");
			provider.add(Radiocraft.translationKey("screen", "chargecontroller.output"), "Output");
